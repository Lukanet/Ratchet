...
class SessionProvider implements HttpServerInterface {
     ...
     */
    public function __construct(HttpServerInterface $app, \SessionHandlerInterface $handler, array $options = array(), HandlerInterface|null $serializer = null) {
        $this->_app     = $app;
     ...
     * {@inheritdoc}
     */
    public function onOpen(ConnectionInterface $conn, RequestInterface|null $request = null) {
